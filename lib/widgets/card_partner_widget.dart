...
import 'package:student_book/widgets/button_widget.dart';
          ...
          children: [
            Row(
              ...
              children: [
                ...
                const Icon(Icons.chevron_right_rounded, color: Colors.white,size: 42,)
              ],
            ),
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Column(
                    children: const [
                      TextWidget('10:00am', isFontWeight: true, color: Colors.white,),
                      TextWidget('Segunda', color: Color(0xB4FFFFFF), fontSize: AvailableFontSizes.small),
                    ],
                  )
                ],
              ),
